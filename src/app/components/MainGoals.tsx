            ...
            <div className="container mx-auto">
                ...
                <div className="mt-20 flex flex-wrap gap-8">
                    {content.map((item: any) => {
                        return (
                            <div key={Math.random()} className="relative w-full max-w-[480px] ">
                                <div className="rounded-xl bg-white flex justify-center items-center mask-goal min-h-[350px] flex-col">
