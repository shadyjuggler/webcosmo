        ...
        >
            {isModal && (
                <h2 className="max-w-[300px] md:max-w-full text-[28px] leading-8 md:leading-9 md:text-3xl !text-[#262B3A]">
                    <span>
                        Позвоним <br className="block md:hidden" /> в течение 15
                        минут,
                    </span>{" "}
                    <br className="hidden md:block" />
                    обсудим условия{" "}
                    <p className="hidden md:block">
                        и просчитаем стоимость работ
                    </p>
                </h2>
            )}
            ...
            <div>
                <button
                    ...
                    className={`btn w-full md:w-fit justify-center md:justify-start btn-blue btn-arrow py-1 ${
                        isModal
                            ? "!w-full !justify-center !py-1.5 md:!px-8"
                            : ""
                    }`}
                    disabled={loading}
                >
                    {loading ? (
                        <>
                            <p className="mx-auto md:mx-0">Отправка...</p>{" "}
