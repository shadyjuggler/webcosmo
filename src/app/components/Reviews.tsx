    ...
    return (
        ...
        >
            <div className="relative container mx-auto">
                <div style={{translate: "0% -85%"}} className="absolute  top-0 xl:top-10 -right-[100px]  md:right-1/5 2xl::right-[500px] max-w-[225px] md:max-w-[250px] lg:max-w-[350px] xl:max-w-[450px]">
