    ...
    return (
        <>
            <main className="main cases" id="main">
                <div className="bg-[#EFF1F5] md:bg-transparent rounded-xl pb-12 sm:pb-16 md:pb-0">
                    ...
                    <div
                        className={`mt-16 md:mt-32  md:bg-transparent flex flex-wrap justify-center gap-3 gap-y-4 max-w-[1680px] mx-auto py-4 sm:py-16 rounded-xl px-4 md:px-0`}
                    >
                        {content.slice(0, pagination)}
                    </div>

                    <div className="mt-8 sm:mt-16 md:mt-32 flex justify-center px-2 sm:px-0">
                        <button
                            onClick={() => {
                                // @ts-ignore
